...
The primary architectural weakness is the router's dependency detection: when it fails
to recognise a staged execution requirement, specialists lack the context they need,
causing cascading failures on hard questions.  Future work could address this with a
more explicit planning step that constructs a dependency graph before dispatching agents.
